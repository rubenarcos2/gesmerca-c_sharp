...
namespace GesMerCa
{
    partial class frmAcercaDe : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = String.Format(Properties.Resources.msgAcercaDeTitulo, AssemblyTitle);
        ...
        {
            btnAceptar.BackgroundImage = Properties.Resources.btnClose;
            btnAceptar.Text = "";
        }

        private void ratonFuera(object sender, EventArgs e)
        {
            btnAceptar.BackgroundImage = null;
            btnAceptar.Text = "X";
        }
